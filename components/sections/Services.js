          ...
          <div className="mil-mb-120">
            <div className="row">
              <div className="col-lg-10">
                {paragraph && (
                  <span className="mil-suptitle mil-light-soft mil-suptitle-right mil-up" dangerouslySetInnerHTML={{ __html: paragraph }} />
                )}
              </div>
            </div>
            {(heading1 || image) && (
              <div className="mil-complex-text justify-content-center align-items-center mil-up mil-mb-15" style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
                {image && (
            ...
            {heading2 && (
              <div className="mil-complex-text justify-content-center align-items-center mil-up" style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
                ...
                <Link href="/services" legacyBehavior>
                  <a className="mil-services-button mil-button mil-arrow-place" style={{ marginLeft: 16, marginTop: 8 }}>
              ...
              <div key={service.id} className="col-md-6 col-lg-3 mil-services-grid-item p-0">
                <Link href={`/services/${service.slug}`} legacyBehavior>
                  <a className="mil-service-card-sm mil-up">
                    <h5 className="mil-muted mil-mb-30" dangerouslySetInnerHTML={{ __html: service.title.rendered }} />
