      ...
      <div className="container mil-p-120-90">
        ...
        <div className="row">
          {visionData.industries.map((industry, index) => {
            ...
            let colClass = "demands-boxes col-md-6 col-lg-2";
            if (index === 0) colClass = "demands-boxes col-md-6 col-lg-2";
            if (index === 1) colClass = "demands-boxes col-md-6 col-lg-2";
            if (index === 2) colClass = "demands-boxes col-md-6 col-lg-2";
