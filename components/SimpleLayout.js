    ...
    <div className="mil-wrapper" id="top">
      ...
      <div className="mil-frame">
        <div className="mil-frame-top">
          <Link href="/" className="mil-logo"><img src="img/logo.png" width="28" alt="logo"></img></Link>
          {/* menu button - placed in header where styling expects it */}
          <div className="mil-menu-btn" onClick={() => setMenuOpen(!menuOpen)}>
            <span></span>
          </div>
        </div>
  ...
  return (
    <div className={`mil-menu-frame${menuOpen ? ' mil-active' : ''}`}>
      <div className="mil-frame-top">
        ...
        <div className="mil-menu-btn" onClick={() => setMenuOpen(false)}>
          <span></span>
        </div>
      </div>
